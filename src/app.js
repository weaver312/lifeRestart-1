    ...
    initPages() {
        ...
        <div id="main">
            ...
            <div id="title">
                ...
                <div style="font-size:0.7rem; font-weight:normal;">本网站使用云开发平台部署，无需服务器和多余的配置，一键把你的前端代码发成可访问网站。</br>欢迎一起魔改：<a href = "https://github.com/AliyunWorkbench/lifeRestart#readme">魔改地址</div>
            </div>
